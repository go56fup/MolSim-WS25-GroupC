...
TRACE_SPECIAL_MEMFUNS_FOR_CLASS("vec_3d")
/// @endcond
{
public:
	...
	/**
	 * @brief Obtains a vector component via axis.
	 * @param self This vector.
	 * @param axis Axis of vector component to retrieve.
	 * @return Reference to vector component with given axis.
	 */
	constexpr same_unqualified_as<Value> auto& operator[](this auto&& self, axis i) {
		switch (i) {
		case axis::x:
			return self.x;
		case axis::y:
