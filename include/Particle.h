...
private:
	...
	void log_special_mem(std::string_view by, const std::source_location& location) {
		std::cout << std::format(
...
public:
	...
	constexpr Particle& operator=(const Particle& other) noexcept {
		...
		m = other.m;
		type = other.type;
		std::cout << "Particle generated by copy assignment!\n";
		return *this;
	}
	...
	constexpr Particle& operator=(Particle&& other) noexcept {
		...
		m = other.m;
		type = other.type;
		std::cout << "Particle generated by move assignment!\n";
		return *this;
	}
