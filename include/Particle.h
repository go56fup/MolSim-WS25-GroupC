...
private:
	 ...
	 */
	static constexpr void runtime_log(std::string_view msg) {
...
// All move semantics code in this file skips the unneeded std::move call for
// Particle's vector members. Ensure that remains a sound decision.
static_assert(std::is_trivially_move_constructible_v<vec>);
