...
struct vec_3d
// TODO(tuna): this prevents static constexpr arrays of vec_3ds, because the if not consteval is not
// present anymore. see if that is still necessary with the macro trick
/*
