...
# Write test source
file(
	WRITE "${EMBED_TEST_DIR}/test_embed.cpp"
	"
...
# Required so try_compile doesn't try to link an executable set(CMAKE_TRY_COMPILE_TARGET_TYPE
# STATIC_LIBRARY)

try_compile(
	HAS_EMBED "${EMBED_TEST_DIR}/build"
