...
/**
 * @gtest_section_cmp_with_params{NE,!=}
 */
...
/** @gtest_section_cmp_with_params{LE,<=} */
...
/** @gtest_section_cmp_with_params{LT,<} */
...
/** @gtest_section_cmp_with_params{GE,>=} */
...
/** @gtest_section_cmp_with_params{GT,>} */
...
/** @gtest_section_str_with_params{STRNE,@different} */
...
/** @gtest_section_str_with_params{STRCASEEQ,@same@case_insens}  */
...
/** @gtest_section_str_with_params{STRCASENE,@different@case_insens}  */
...
/**
 * @gtest_section_fp{FLOAT_EQ,float}
 *
 * Checks if values are within 4 ULPs from each other. Infinity and the largest finite float
...
/** @gtest_section_fp_with_params{DOUBLE_EQ,double} */
...
/** @gtest_header{NEAR,val1,val2,abs_error}
 *
 * @brief Verifies that the difference between `val1` and `val2` does not
 * exceed the absolute error bound `abs_error`.
 *
 * If `val1` and `val2` are both infinity of the same sign, the difference is considered to be 0.
